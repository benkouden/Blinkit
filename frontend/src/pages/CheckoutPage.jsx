...
const CheckoutPage = () => {
  ...
  const handleOnlinePayment = async () => {
    try {
      ...
      if (!stripePublicKey) {
        console.log('Clé publique Stripe manquante dans VITE_STRIPE_PUBLIC_KEY')
      }

      if (!stripePromise) {
        console.log('Échec du chargement de Stripe. Vérifie ta clé publique.')
      }
        ...
        <div className='w-full'>
          ...
          <div className='grid gap-4 p-2 bg-white'>
            ...
            <div
              ...
              className='flex items-center justify-center h-16 border-2 border-dashed cursor-pointer bg-blue-50'
            >
              Add address
            </div>
          </div>
        ...
        <div className='w-full max-w-md px-2 py-4 bg-white'>
          ...
          <div className='flex flex-col w-full gap-4'>
            ...
            <button
              ...
              className='px-4 py-2 font-semibold text-green-600 border-2 border-green-600 hover:bg-green-600 hover:text-white'
            >
              Cash on Delivery
            </button>
          </div>
