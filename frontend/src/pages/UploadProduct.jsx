...
const UploadProduct = () => {
  ...
  const handleDeleteImage = async (index) => {
    // Créer une copie du tableau d'images sans la supprimer directement de 'data.image'
    const updatedImages = [...data.image];
    updatedImages.splice(index, 1);  // Supprime l'image à l'index spécifié

    // Mettre à jour l'état avec le tableau d'images mis à jour
    setData((prev) => {
        return {
            ...prev,  // Conserve les autres propriétés de 'data'
            image: updatedImages,  // Remplace l'ancienne liste d'images par la nouvelle
        };
    });
};
